...
When the pre-production sample landed on my desk, the first thing I noticed was the design.
...
Now let's get into the most important part — how it actually plays.
